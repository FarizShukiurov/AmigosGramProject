...
import "./Layout.css";
function Layout() {
    const [avatarUrl, setAvatarUrl] = useState("/default-avatar.jpg"); // Значение по умолчанию
                ...
                <aside className="navbar">
                    ...
                    <nav className="menu">
                        <button className="menu-item">
                            <Link to="/contacts"><img src="src\assets\Contacts.svg" alt="Contacts" /></Link>
                        </button>
                        <button className="menu-item">
                            <Link to="/chats"><img src="src\assets\Chats.svg" alt="Chats" /></Link>
                        </button>
                        <button className="menu-item">
